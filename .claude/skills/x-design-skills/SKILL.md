---
name: x-design-skills
description: SpaceX-inspired design system for this project. Use whenever building, editing, or styling any UI — HTML pages, CSS, components, landing pages, signin/signup forms, dashboards, or any visual surface. Enforces pure black canvas, full-viewport photography, D-DIN uppercase typography with positive letter-spacing, spectral white text (#f0f0fa), ghost buttons, zero shadows, and zero cards/containers. Trigger on requests like "style this page", "build a hero", "design a form", "make it look good", "apply the design system", or whenever writing/editing .html/.css/.tsx/.jsx files.
---
